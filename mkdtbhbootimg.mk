...
MKDTBIMG := $(HOST_OUT_EXECUTABLES)/mkdtbimg$(HOST_EXECUTABLE_SUFFIX)
...
$(INSTALLED_DTIMAGE_TARGET): $(MKDTBIMG) $(INTERNAL_BOOTIMAGE_FILES)
	$(call pretty,"Target dtb image: $@")
	$(hide) $(MKDTBIMG) --dt_dir $(KERNEL_OUT)/arch/arm/boot/dts/ --output $@
	@echo -e ${CL_CYN}"Made dtb image: $@"${CL_RST}
...
.PHONY: dtbimage
dtbimage: $(INSTALLED_DTIMAGE_TARGET)
